...
function CountTensFramesQuiz({
  ...
  var fromattedquestionContent = state?.questionContent.map((content) => {
    var formattedImage = addLazyLoading(content.image);
    return { ...content, image: formattedImage };
  });
  return (
    <div>
      ...
      <div id="studentAnswerResponse">
        <div className={`${styles.questionName}`}>
          {HtmlParser(formattedQuestionName)}
        </div>
        ...
        <div className={styles.contentParent}>
          {Boolean(totalRows) && (
            <ContentCountTensframeQuiz
              ...
              content={fromattedquestionContent}
