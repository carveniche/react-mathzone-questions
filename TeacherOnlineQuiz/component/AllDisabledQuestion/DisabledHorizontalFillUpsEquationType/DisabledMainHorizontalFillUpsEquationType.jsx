...
import DisabledHorizontalFillUpsEquationType from "./DisabledHorizontalFillUpsEquationType";
...
let obj = {
  ...
  questionContent: [
    { row: 0, col: 0, value: "1+2", isMissed: "true" },
    {
      row: 0,
      col: 1,
      value:
    ...
    { row: 1, col: 0, value: "1+3", isMissed: "false" },
    {
      row: 0,
      col: 3,
      value:
    ...
    { row: 0, col: 4, value: "1+4", isMissed: "false" },
  ],
  solution: {
    model: [{ val: "$\\sqrt{2}$" }],
    sidebyside: [],
...
export default function DisabledMainHorizontalFillUpsEquationType({obj, meter }) {
  return (
    <DisabledHorizontalFillUpsEquationType
      state={obj}
      totalRows={obj.rows}
      totalCols={obj.cols}
      meter={meter}
