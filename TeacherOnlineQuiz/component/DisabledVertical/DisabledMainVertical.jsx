...
import DisabledVertical from "./DisabledVertical"
let obj={
    "operation":"addition",
    "type":"vertical",
    "rows":"3",
    ...
    "choiceType":"keyingdragdrop",
    "choiceCount":9
 }

export default function DisabledMainVertical({meter})
{
    return <DisabledVertical state={obj} totalRows={obj.rows} totalCols={obj.cols} meter={meter}/>
}