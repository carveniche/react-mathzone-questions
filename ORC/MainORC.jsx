...
//         "question_type":"orc",
//         "upload_file_name":"https://www.google.com/imgres?imgurl=https%3A%2F%2Fwww.shorturl.at%2Fimg%2Fshorturl-icon.png&imgrefurl=https%3A%2F%2Fwww.shorturl.at%2F&tbnid=BItbp5rBnoFabM&vet=12ahUKEwiA7ve32vX4AhXK_jgGHWD3CcYQMygAegUIARC9AQ..i&docid=8m5cWULGS8amNM&w=350&h=350&itg=1&q=small%20url%20size%20image&ved=2ahUKEwiA7ve32vX4AhXK_jgGHWD3CcYQMygAegUIARC9AQ",
//         "level":"level2",
//         "fib_text":null,
//         "fib_before_text":null,
//         "after_question_text":"akd,dkddkddii",
//         "choice_data":[
...
export default function MainOrc({ obj2, meter }) {
  return (
    <ORC
      obj={obj2?.question_data[0]}
      question_text={obj2?.question_data[0]?.question_text}
      meter={meter}
    />
  );
}
