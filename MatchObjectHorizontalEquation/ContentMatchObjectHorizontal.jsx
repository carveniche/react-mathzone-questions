...
export default function ContentMatchObjectHorizontal({content,hasAnswerSubmitted,totalEmptyBox,inputRef,choices,totalRows,choiceType,totalCols,equationKeyingRef})
{
    ...
    return <div>
      ...
      (choiceType=='dragdrop'||choiceType=='selectchoice') &&<HorizontalDragAndDropType content={content} choices={choices} inputRef={inputRef} totalEmptyBox={totalEmptyBox} totalRows={totalRows}/>
        ...
        {
            choiceType=='keying' &&<HorizontalKeyingChoiceType content={content} inputRef={inputRef} totalEmptyBox={totalEmptyBox} totalRows={totalRows} hasAnswerSubmitted={hasAnswerSubmitted} totalCols={totalCols}
