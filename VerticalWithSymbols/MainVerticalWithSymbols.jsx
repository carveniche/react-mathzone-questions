...
import VerticalWithSymbols from "./VerticalSymbols"
// let obj={
//     "operation":"addition",
...
//     "answer":"140"
//  }
export default function MainVerticalWithSymbols({obj,meter})
{
    return <VerticalWithSymbols state={obj} totalRows={obj.rows} totalCols={obj.cols} meter={meter}/>
}